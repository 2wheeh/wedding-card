...
// TODO
// const dateKr = new Date(date.toLocaleString('en-US', { timeZone: 'Asia/Seoul' }));
// const year = dateKr.getFullYear();
// const month = dateKr.getMonth();
// const day = dateKr.getDate();
// const hour = dateKr.getHours();
// const minute = dateKr.getMinutes();

// const dayPeriod = hour < 11 ? '오전' : hour < 14 ? '낮' : hour < 17 ? '오후' : '저녁';
